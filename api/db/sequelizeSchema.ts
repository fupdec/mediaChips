...
const sqlite3 = require('../utils/sqlite3-compat')

function attachSequelizeModels(sequelize: import('sequelize').Sequelize) {
...
function createMigrationSequelize(dbPath: string) {
  ...
  return attachSequelizeModels(sequelize)
}

module.exports = {
  attachSequelizeModels,
  createMigrationSequelize,
}