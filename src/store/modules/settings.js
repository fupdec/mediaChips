...
dbs.defaults({
  ...
  delayVideoPreview: 0,
  appColorLightPrimary: '#FFB526',
  appColorLightSecondary: '#098DFF',
  appColorLightAccent: '#FF427F',
  appColorLightHeader: '#FFE8F0',
  appColorDarkPrimary: '#D37816',
  appColorDarkSecondary: '#347EC5',
  appColorDarkAccent: '#B8164A',
