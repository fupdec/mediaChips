...
dbs.defaults({
  ...
  delayVideoPreview: 0,
  appColorLightPrimary: '#0BD580',
  appColorLightSecondary: '#008DFF',
  appColorLightAccent: '#E61A53',
  appColorLightHeader: '#FFE8F0',
  appColorDarkPrimary: '#0B9673',
  appColorDarkSecondary: '#0D67B1',
  appColorDarkAccent: '#A80F4F',
  appColorDarkHeader: '#563C58',
  darkMode: false,
  headerGradient: true,
  headerGradientLight: 'linear-gradient(to right,#F87D24,#EC38D5)',
  headerGradientDark: 'linear-gradient(to right,#973A0B,#80084E)',
  textFont: 'Roboto',
  headerFont: 'Roboto',
  navigationSide: "1",
